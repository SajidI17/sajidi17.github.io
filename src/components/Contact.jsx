  ...
  return (
    <div className='text-white mx-auto max-w-screen-md py-48'>
        ...
        <form action='#' className='space-y-5'>
            <div>
                <label for='email' className='block pb-2 font-medium text-sm'>Your Email *</label>
            ...
            <div>
                <label for='subject' className='block pb-2 font-medium text-sm'>Subject *</label>
            ...
            <div>
              <label for='message' className='block pb-2 font-medium text-sm'>Message *</label>
            ...
            <button type="submit" className='py-2 px-3 rounded-lg font-medium text-center bg-blue-700'>Send</button>
        </form>
    </div>
  )
}
